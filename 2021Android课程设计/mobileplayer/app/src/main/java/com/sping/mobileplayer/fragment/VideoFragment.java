...
import com.sping.mobileplayer.adapter.VideoListAdapterRV;

import java.io.Serializable;

public class VideoFragment extends BaseFragment implements Serializable {

    private VideoListAdapterRV mAdapter;
    ...
    public void initView() {
        ...
        if (mAdapter == null) {
            ...
            mAdapter = new VideoListAdapterRV(getContext(), c, 1);//
        }
